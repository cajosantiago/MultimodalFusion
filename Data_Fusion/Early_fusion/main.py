...
if __name__ == '__main__':
    ...
    #Defining the model
    model = networks.Multimodal_fusion(args=args)
    model.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_modalities, train_stats = engine.train_step(model=model,
        ...
        #removed wand
        val_modalities, results = engine.evaluation(model=model,
