...
cptac_csv_path = "../Files/CPTAC/Ranking_MR_short.csv"
tcga_csv_path = "../Files/TCGA/Ranking_MR_short.csv"

# Define the path to the output CSV file
output_csv_path = "../Files/patients_with_labels_MR.csv"
...
with open('../Files/MR_failed_shapes.txt', 'r') as f:
