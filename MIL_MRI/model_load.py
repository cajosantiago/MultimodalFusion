...
if __name__ == '__main__':
    ...
    ################### DATA SETUP ########################
    patient_list = 'Files/patient_list_MR.csv'
    CT_scans = 'Files/MR_scans_dataset.csv'

    #Defining the dataloaders
    dataset_CT = data_load.FeatureDataset(patient_list, CT_scans, bag_size=47)
    ...
    checkpoint_path = 'model_x/best_checkpoint_02.pth'
    ...
    csv_file_path = "chosen_exams/patient_position_data_FINAL.csv"
