...
from datasets.datasets50 import BrainS18Dataset
import torch
import numpy as np
...
class MedicalNet(nn.Module):
  ...
  def __init__(self, path_to_weights, device):
    ...
    self.model = resnet.resnet50(sample_input_D=56, sample_input_H=448, sample_input_W=448, num_seg_classes=2)
...
if __name__ == '__main__':
    ...
    # generate model
    path_to_weights = '/home/csantiago/MRI_CT_extraction/MedicalNet/pretrain/resnet_50_23dataset.pth'
    ...
    img_direct = '/home/csantiago/Datasets/Radiology-CPTAC/full_file_location_CT50.txt'
    with open(img_direct, 'r') as f:
        img_list = [line.strip() for line in f]

    folder_name = 'feature_map'
    filename_features = 'feature_map50.npz'
