...
input_file = '../Files/slide_location.csv'
...
for case_id in df['case_id'].unique():
    ...
    if count < 8:
        ...
        additional_rows = pd.DataFrame({
            ...
            'slide_location': ['Not applicable'] * rows_to_add,
        })
...
result_df = result_df.sort_values(['case_id', 'slide_location'])

output_file = '../Files/pathology_dataset.csv'
