...
class MlpCLassifier(nn.Module):
    ...
    def __init__(self, in_features, hidden_size=512 , out_features=2, dropout=0.0):
...
class InstanceMIL(nn.Module):
    ...
    def __init__(self, 
        ...
        self.deep_classifier = MlpCLassifier(in_features=embedding_size, hidden_size = 512,  out_features=num_classes, dropout=dropout)    
    ...
    def forward(self, x, numb_fmap):
        ...
        Forward pass of the InstanceMIL model.
            Input required: x (Batch_size, bag_size, 1024, 1)
            Current input: x [1, 7, 1, 1024]) (Batch_size, bag_size, batch_size, 1024) 
        ...
        # Deep classifier output shape: (7,2)
